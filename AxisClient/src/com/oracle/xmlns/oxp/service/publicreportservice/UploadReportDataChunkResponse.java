...
/**
 * UploadReportDataChunkResponse.java
 *
 ...
 */
            ...
            /**
            *  UploadReportDataChunkResponse bean class
            */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       UploadReportDataChunkResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"uploadReportDataChunkReturn", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"uploadReportDataChunkReturn");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("uploadReportDataChunkReturn");
                                    }
                                          ...
                                          if (localUploadReportDataChunkReturn==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("uploadReportDataChunkReturn cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://xmlns.oracle.com/oxp/service/PublicReportService",
                                        ...
                                        if (localUploadReportDataChunkReturn != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUploadReportDataChunkReturn));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("uploadReportDataChunkReturn cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static UploadReportDataChunkResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UploadReportDataChunkResponse object =
                new UploadReportDataChunkResponse();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"uploadReportDataChunkResponse".equals(type)){
                                ...
                                return (UploadReportDataChunkResponse)com.oracle.xmlns.oxp.service.publicreportservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://xmlns.oracle.com/oxp/service/PublicReportService","uploadReportDataChunkReturn").equals(reader.getName())){
