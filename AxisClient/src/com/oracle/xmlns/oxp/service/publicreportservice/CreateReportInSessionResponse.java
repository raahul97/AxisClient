...
/**
 * CreateReportInSessionResponse.java
 *
 ...
 */
            ...
            /**
            *  CreateReportInSessionResponse bean class
            */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CreateReportInSessionResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"createReportInSessionReturn", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"createReportInSessionReturn");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("createReportInSessionReturn");
                                    }
                                          ...
                                          if (localCreateReportInSessionReturn==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("createReportInSessionReturn cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://xmlns.oracle.com/oxp/service/PublicReportService",
                                        ...
                                        if (localCreateReportInSessionReturn != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCreateReportInSessionReturn));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("createReportInSessionReturn cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static CreateReportInSessionResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateReportInSessionResponse object =
                new CreateReportInSessionResponse();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createReportInSessionResponse".equals(type)){
                                ...
                                return (CreateReportInSessionResponse)com.oracle.xmlns.oxp.service.publicreportservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://xmlns.oracle.com/oxp/service/PublicReportService","createReportInSessionReturn").equals(reader.getName())){
